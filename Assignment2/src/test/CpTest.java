...
public class CpTest {
  ...
  public void testCpValidArguments() throws Exception{
    ...
    assertEquals("/test/test1/copyingThis",
  ...
  /**
   * Test Cp execute command with arguments of the same name
   */
  @Test()
  public void testCpWithSameName(){
    expected = "Error: Directory of this name already exists";
  ...
  public void testCpWithInvalidPath(){
    ...
    // Set arguments
    arguments = new String[] {"/test/copyingThis", "/test/test1"};
  ...
  public void testCpWithIncorrectContentType(){
    expected = "Error: Cannot copy to a file";
