...
public class CommandMaster {
   ...
   */
  private void formatOutput(FileSystem fileSystem, String[] arguments, String output, String redirectIndicator) {
    ...
    if (redirectIndicator.equals(APPENDSYMBOL) || 
        redirectIndicator.equals(OVERWRITESYMBOL) && 
      ...
      if (!validPath && output != null && !output.isEmpty()) {
